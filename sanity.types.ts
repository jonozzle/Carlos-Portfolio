...
export type AllSanitySchemaTypes = Spacer | ProjectBlock | SingleImage | PageLinkSection | HalfWidthDoubleProject | HalfWidthSingleProject | AdSection | ProjectDetail | ThreeGallery | AllPosts | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | HeroContents | Hero2 | Hero1 | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Footer | Settings | Navigation | Testimonial | Faq | Category | Page | Project | Post | Author | Code | Color | RgbaColor | HsvaColor | HslaColor | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
